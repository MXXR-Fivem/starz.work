export const AIcon = ({ width = "40px", height = "40px", color = "var(--starz-color-primary)", ...props }) => (
  <svg {...props} fill={color} width={width} height={height} viewBox="0 0 128 128" id="Layer_1" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <g>
